...
import useIndex from 'views/home/index.hook'
    ...
    return (
        <main className={styles['index-page']}>
                    ...
                    <Columns>
                        <Columns.Column>
                            <p>
                                ...
                                <em>architecture logicielle</em>, le développement <em>full stack</em>, l'automatisation <em>CI/CD</em>, le
                                cloud <em>Azure</em> et l'<em>accompagnement technique d'équipes</em>.
                                <br />
                                <br />
                                Spécialisé en <em>TypeScript</em>, <em>React</em> et <em>Node.js/NestJS</em>, j'ai obtenu à Ynov Nantes mon
                                mastère « <em>Expert Développement Web</em> » et le titre RNCP «{' '}
                                <em>Expert Informatique et Systèmes d'Information</em> ». Habitué aux environnements multi-projets, aux
                                échanges directs avec les clients métiers et à la bonne compréhension de l'<em>anglais</em>, j'interviens du
                                cadrage fonctionnel initial jusqu'à la mise en production.
                                <br />
                                <br />
                            </p>
                            <br />
                    ...
                    <Columns>
                        <Columns.Column>
                            ...
                            >
                                ...
                                >
                                    Rigoureux dans mon travail et exigeant sur la qualité, j'aime néanmoins garder une touche d'humour au
                                    quotidien. Parce qu'une bonne ambiance de travail, c'est aussi ce qui fait la différence au sein d'une
                                    équipe.
                                </IconCard>
                            </Fade>
                        </Columns.Column>
                        <Columns.Column>
                            ...
                            >
                                ...
                                >
                                    Je m'investis pleinement dans chaque projet tout en gardant le recul nécessaire pour prendre les bonnes
                                    décisions. L'humain reste au cœur de mon approche : écoute, implication et relation de confiance avec
                                    les clients comme avec l'équipe.
                                </IconCard>
                            </Fade>
                        </Columns.Column>
                        <Columns.Column>
                            ...
                            >
                                ...
                                >
                                    Passionné d'informatique depuis toujours, j'aborde chaque problème comme un défi à relever. La recherche
                                    de la meilleure solution, même lorsque c'est complexe, est ce qui me motive au quotidien.
                                </IconCard>
                            </Fade>
                        </Columns.Column>
                    </Columns>
                        ...
                        <Columns>
                                ...
                                <SkillCard
                                    ...
                                    description={
                                        <>
                                            ...
                                            backend robuste avec <strong>NestJS</strong> et <strong>Fastify</strong>, frontend réactif avec{' '}
                                            <strong>React</strong>. Culture forte de la <strong>qualité</strong> : typage strict, revues de
                                            code, CI, tests unitaires et E2E pour une base de code{' '}
                            ...
                            <Columns.Column sizes={['one-third-widescreen', 'one-third-desktop', 'half-tablet']}>
                                <SkillCard
                                    ...
                                    description={
                                        <>
                                            Architecture et intégration d'interfaces exigeantes : composants <strong>réutilisables</strong>,{' '}
                                            <strong>design systems</strong>, animations fluides et gestion d'état complexe. Sensibilité à l'
                                            <strong>accessibilité</strong> (WCAG), au <strong>SEO</strong> et aux{' '}
                                            <strong>Core Web Vitals</strong> pour des applications à la fois esthétiques et performantes.
                                        </>
                                    }
                        ...
                        <Columns>
                            <Columns.Column sizes={['one-third-widescreen', 'one-third-desktop', 'half-tablet']}>
                                <SkillCard
                                    ...
                                    description={
                                        <>
                                            Conception d'<strong>APIs REST</strong> typées et documentées (OpenAPI/Swagger), modélisation de
                                            schémas relationnels et NoSQL. Du schéma initial aux requêtes optimisées, avec un œil constant
                                            sur la <strong>cohérence des données</strong>.
                                        </>
                                    }
                            ...
                            <CareerCard
                                ...
                                missions={[
                                    ...
                                    },
                                    {
                                        ...
                                        description: "Apprentissage général de l'informatique : développement, réseau et culture générale",
                                    },
                                ]}
                ...
                <Container>
                    ...
                    <Columns>
                        ...
                        <Columns.Column>
                            ...
                            <br />
                            <p>
                                Pour un projet de cette taille, <em>Next.js</em> est clairement « overkill », un site statique serait plus
                                léger. Ce choix est délibéré : il me permet de démontrer concrètement mes compétences essentielles en{' '}
                                <em>React</em>.
                            </p>
                            <br />
                            <p>
                                Ce projet couvre l'ensemble du cycle de vie d'une application : de la <em>conception</em> (maquettes, choix
                                techniques) au <em>déploiement</em> continu, en passant par le <em>développement</em> (architecture en
                                composants, style, accessibilité, performance).
                            </p>
                            <br />
                            <p>
            ...
            <div className={classNames(styles['index-page-row'], styles['is-quote'])}>
                ...
                <hr />
                <p>
                    Une simple locution qui, bien que tirée d'un dessin animé, m'a toujours inspiré, notamment dans mes projets personnels
                        ...
                        <Columns.Column sizes={['one-third-desktop', 'half-tablet']}>
                            ...
                            >
                                <FlatCard
                                    ...
                                    title="Collections"
                                >
                                    Collectionneur passionné depuis mon plus jeune âge, j'ai toujours aimé chiner des objets variés : pièces
                                    d'euros, timbres, fèves, jeux vidéo, et bien d'autres.
                                    <br />
                                    <br />
                                    Aujourd'hui, ma collection principale tourne autour du groupe In Flames : CD, vinyles et autres raretés.
                                    Je partage cette passion sous le pseudonyme :{' '}
                                    <a
                        ...
                        <Columns.Column sizes={['one-third-desktop', 'half-tablet']}>
                            ...
                            >
                                <FlatCard
                                    ...
                                    title="Développement"
                                >
                                    Plus qu'un métier, le développement est une véritable passion. Je m'amuse régulièrement à concevoir des
                                    projets variés, qu'ils soient open source ou pour mon usage personnel (
                                    <a
                                        aria-label="github.com/KirianCaumes, ouvre dans un nouvel onglet"
                                        href="https://github.com/KirianCaumes"
